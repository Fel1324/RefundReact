...
const refundSchema = z.object({
  ...
  amount: z.coerce.number("Informe um valor válido").positive("Informe um valor válido e superior a zero")
})
...
export function Refund() {
  ...
  return (
    <form onSubmit={onSubmit} className="bg-gray-500 w-full rounded-xl flex flex-col p-10 mx-auto gap-6 max-w-[512px]">
      <header>
